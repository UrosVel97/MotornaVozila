...
{
    public partial class DodajRadnikaEkonomskeStruke : Form
    {
        public DodajRadnikaEkonomskeStruke()
        {
            InitializeComponent();
        }
        ...
        private void DodajRadnikaEkonomskeStruke_Load(object sender, EventArgs e)
        {
            label10.Visible = false;
            label11.Visible = false;
            txtPlata.Visible = false;
        ...
        private void btnSnimi_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                RadnikEkonomskeStruke rts = new RadnikEkonomskeStruke()
                {
