...
{
    public partial class DodajRadnikaTehnickeStruke : Form
    {
        public DodajRadnikaTehnickeStruke()
        {
            InitializeComponent();
        }
        ...
        private void DodajRadnikaTehnickeStruke_Load(object sender, EventArgs e)
        {
            label10.Visible = false;
